...
export default class SettingItem extends React.Component {
    ...
    render(){
        ...
        if (isOpen) {
            content = (
                <div className={classnames('setupItemContentWrap', (_.isArray(this.props.children) || this.props.oneToMulti)?'MultiSetupItemContentWrap':null)}>
                    <div className="setupItemContent">
                        {this.props.children}
                    </div>
                    <div className="setupItemFooter">
                        <button
                            className="closeBtn"
                            onClick={this.expandItems.bind(this, false)}
                        >
                            {locale.closeLabel}
                        </button>
                        <button
        ...
        return (
            <li className={classnames("setupitem", this.props.className,openClass)}>
