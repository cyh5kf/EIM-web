var r = ["AREA", "BASE", "BR", "COL", "EMBED", "HR", "IMG", "INPUT", "KEYGEN", "LINK", "MENUITEM", "META", "PARAM", "SOURCE", "TRACK", "WBR", "BASEFONT", "BGSOUND", "FRAME", "ISINDEX"];
...
function t(e) {
    return 1 === e.nodeType && !arrayContains(r, e.nodeName)
}
...
CursorManager.setEndOfContenteditable = function (e) {
    for (; getFirstChild(e) && t(getFirstChild(e));)
        e = getFirstChild(e);
